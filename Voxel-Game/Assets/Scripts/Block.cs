...
public class Block
{
    ...
    static Vector3[] forwardVector = new Vector3[] { Vector3.forward, Vector3.forward, Vector3.forward, Vector3.forward };
    static Vector3[] backVector = new Vector3[] { Vector3.back, Vector3.back, Vector3.back, Vector3.back };
    static Vector3[] leftVector = new Vector3[] { Vector3.left, Vector3.left, Vector3.left, Vector3.left };
    static Vector3[] rightVector = new Vector3[] { Vector3.right, Vector3.right, Vector3.right, Vector3.right };
    static Vector3[] upVector = new Vector3[] { Vector3.up, Vector3.up, Vector3.up, Vector3.up };
    static Vector3[] downVector = new Vector3[] { Vector3.down, Vector3.down, Vector3.down, Vector3.down };
